...
use OpenDxp\Bundle\DataImporterBundle\DependencyInjection\CompilerPass\MultiAttributeConfigurationFactoryPass;
...
class PimcoreDataImporterBundle extends AbstractOpenDxpBundle implements DependentBundleInterface, OpenDxpBundleAdminClassicInterface
{
    use BundleAdminClassicTrait;
    use PackageVersionTrait;

    const string LOGGER_COMPONENT_PREFIX = 'DATA-IMPORTER ';
    ...
    public function getJsPaths(): array
    {
        return [
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/resolver/load/multiAttribute.js',
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/resolver/location/findParentAndCreateFolder.js',
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/mapping/operator/numericRange.js',
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/mapping/operator/time.js',
    ...
    public function build(ContainerBuilder $container): void
    {
        $container
            ...
            ->addCompilerPass(new MultiAttributeConfigurationFactoryPass())
