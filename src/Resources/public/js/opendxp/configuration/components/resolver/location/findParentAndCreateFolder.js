...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.findParentAndCreateFolder');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.findParentAndCreateFolder = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {

    type: 'findParentAndCreateFolder',
    dataApplied: false,
        ...
        if(!this.form) {
            ...
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                items: [
                    {
                        xtype: 'combo',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_find_strategy'),
                        ...
                        store: [
                            ...
                            ['attribute', t('plugin_opendxp_datahub_data_importer_configpanel_find_strategy_attribute')]
                        ],
                        listeners: {
                    ...
                    languageSelection,
                    {
                        ...
                        xtype: 'textfield',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_fallback_path'),
                        name: this.dataNamePrefix + 'fallbackPath',
                        value: this.data.fallbackPath
                    },{
                        xtype: 'textfield',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_folder_name'),
                        name: this.dataNamePrefix + 'folderName',
                        value: this.data.folderName
                    }
                ]
            });
        }
