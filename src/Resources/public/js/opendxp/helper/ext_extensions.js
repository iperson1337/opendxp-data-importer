...
Ext.define('DataHub.DataImporter.ArrayField', {
    ...
    // Override initComponent to set up the field
    ...
    // Override getValue to return the array directly
    getValue: function() {
        return this.value;
    },

    // Override setValue to handle array values
    ...
    // Override getRawValue to return the array
    getRawValue: function() {
        return this.getValue();
    },

    // Override setRawValue to set the array
    ...
    initComponent: function() {
        ...
        for(let optionType in me.optionsNamespace) {
            ...
            if(!this.optionsBlackList.includes(optionType)) {
                dataTypesStore.push([
                    optionType,
                    t('plugin_opendxp_datahub_data_importer_configpanel_' + this.name + '_' + optionType)
                ]);
            }
