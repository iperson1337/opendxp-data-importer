...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType = Class.create({
