...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.importSettings');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.importSettings = Class.create({
                    ...
                    listeners: {
                        change: function(combo, newValue, oldValue) {
                            ...
                            this.configItemRootContainer.fireEvent(
                                opendxp.plugin.pimcoreDataImporterBundle.configuration.events.classChanged,
                                combo,
                                newValue,
                                oldValue
                            );
                        ...
                        added: function(combo) {
                            this.configItemRootContainer.fireEvent(
                                opendxp.plugin.pimcoreDataImporterBundle.configuration.events.classInit,
                                combo,
                                combo.getValue(),
                            );
                        }.bind(this)
                    ...
                    items: [
                        {
                            ...
                            optionsNamespace: opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.load,
                    ...
                    items: [
                        {
                            ...
                            optionsNamespace: opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location,
                    ...
                    items: [
                        {
                            ...
                            optionsNamespace: opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.publish,
    ...
    buildProcessingTab: function() {
        ...
        const cleanupStrategy = Ext.create('DataHub.DataImporter.SubSettingsComboBox', {
            ...
            disabled: !this.processingConfigData.idDataIndex || 0 === this.processingConfigData.idDataIndex.length,
            optionsNamespace: opendxp.plugin.pimcoreDataImporterBundle.configuration.components.cleanup,
    ...
    buildMappingsTab: function() {
        ...
        this.mappingConfiguration = new opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfiguration(
