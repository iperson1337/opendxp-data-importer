...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.staticPath');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.staticPath = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
