...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.findParent');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.findParent = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
