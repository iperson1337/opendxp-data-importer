...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.load.id');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.load.id = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
