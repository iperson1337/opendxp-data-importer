...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.findParentAndCreateFolder');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.resolver.location.findParentAndCreateFolder = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
            ...
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                items: [
                    ...
                    languageSelection,
                    {
                        ...
                        xtype: 'textfield',
                        fieldLabel: t('plugin_pimcore_datahub_data_importer_configpanel_folder_name'),
