...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.interpreter.xml');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.interpreter.xml = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
