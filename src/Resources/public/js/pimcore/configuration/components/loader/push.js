...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.push');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.push = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
                ...
                items: [
                    {
                        ...
                        items: [
                            {
                                xtype: 'label',
                                text: location.protocol + '//' + location.host + '/opendxp-datahub-import/' + this.initContext.configName + '/push'
                            }
                        ]
                    }
