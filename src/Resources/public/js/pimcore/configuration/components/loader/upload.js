...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.upload");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.upload = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
    ...
    buildSettingsForm: function() {
        if(!this.form) {
            ...
            let items = [];
            const url = Routing.generate('opendxp_dataimporter_configdataobject_uploadimportfile', {'config_name': this.initContext.configName});
    ...
    updateUploadStatusInformation: function() {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_dataimporter_configdataobject_hasimportfileuploaded'),
            method: 'GET',
            params: {
