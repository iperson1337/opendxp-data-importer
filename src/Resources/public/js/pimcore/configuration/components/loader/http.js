...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.http");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.http = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
