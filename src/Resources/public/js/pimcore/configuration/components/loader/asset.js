...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.asset");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.asset = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
