...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.sftp");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.loader.sftp = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
