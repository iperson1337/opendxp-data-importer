...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.logTab');
...
if(opendxp.log) {
    baseClass = opendxp.log.admin;
}
else {
    baseClass = opendxp.bundle.applicationlogger.log.admin;
}
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.logTab = Class.create(baseClass, {
