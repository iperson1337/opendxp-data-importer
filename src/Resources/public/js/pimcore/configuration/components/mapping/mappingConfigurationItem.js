...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfigurationItem');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfigurationItem = Class.create({
    ...
    buildMappingConfigurationItem: function () {
        ...
        if (!this.form) {
            ...
            this.transformationResultType = Ext.create('Ext.form.TextField', {
                ...
                listeners: {
                    change: function (field, newValue, oldValue) {
                        ...
                        this.form.fireEvent(
                            opendxp.plugin.pimcoreDataImporterBundle.configuration.events.transformationResultTypeChanged,
                            newValue
                        );
                    }.bind(this)
                }
            ...
            this.configItemRootContainer.on(
                opendxp.plugin.pimcoreDataImporterBundle.configuration.events.transformationResultPreviewUpdated,
                    ...
                    items: [
                        {
                            ...
                            optionsNamespace: opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.datatarget,
    ...
    buildTransformationPipeline: function (data) {
        ...
        for (let i = 0; i < itemTypes.length; i++) {
            const menuGroup = opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator[itemTypes[i]].prototype.getMenuGroup();
            const iconClass = opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator[itemTypes[i]].prototype.getIconClass();
            if (menuGroup) {
    ...
    addTransformationPipelineItem: function (type, data, container) {
        const item = new opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator[type](
    ...
    updateValidationState: function () {
        try {
            if (this.form.isValid()) {
                ...
                this.form.setIconCls('opendxp_icon_warning');
            }
        } catch (e) {
