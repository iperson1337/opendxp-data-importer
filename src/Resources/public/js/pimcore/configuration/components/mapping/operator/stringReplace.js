...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator.stringReplace");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator.stringReplace = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.abstractOperator, {
    ...
    getIconClass: function() {
        return 'opendxp_icon_operator_stringreplace';
    },
