...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator.quantityValue");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.operator.quantityValue = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.abstractOperator, {
    ...
    getFormItems: function () {
        ...
        const unitStore = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_dataimporter_configdataobject_loadunitdata'),
                reader: {
                    type: 'json',
