...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfiguration');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfiguration = Class.create({
    ...
    addItem: function(mappingItemData, collapsed, scrollToBottom) {
        const mappingConfigurationItem = new opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.mappingConfigurationItem(mappingItemData, this.configItemRootContainer, this.transformationResultHandler);
    ...
    isValid: function(expandPanels) {
        ...
        this.panel.items.items.forEach(function(item) {
            ...
            if(!item.isValid()) {
                item.setIconCls('opendxp_icon_warning');
                if(expandPanels) {
                    item.expand();
                }
