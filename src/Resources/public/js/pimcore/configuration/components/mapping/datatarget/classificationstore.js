...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.datatarget.classificationstore');

opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.datatarget.classificationstore = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
    ...
    buildSettingsForm: function() {
        ...
        if(!this.form) {
                ...
                items: [
                    this.clsKeySelectionLabel,
                    {
                        ...
                        handler: function() {
                            ...
                            let searchWindow = new opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.tools.classificationStoreKeySearchWindow(
                ...
                listeners: {
                    afterlayout: function() {
                        if(!this.keyNameLoaded) {
                            ...
                            if(this.data.keyId) {
                                Ext.Ajax.request({
                                    url: Routing.generate('opendxp_dataimporter_configdataobject_loaddataobjectclassificationstorekeyname'),
                                    method: 'GET',
                                    params: {
            ...
            this.initContext.mappingConfigItemContainer.on(opendxp.plugin.pimcoreDataImporterBundle.configuration.events.transformationResultTypeChanged, function(newType) {
    ...
    initAttributeStore: function(attributeStore) {
        ...
        if(classificationStoreFieldCache[classId]) {
            ...
            Ext.Ajax.request({
                url: Routing.generate('opendxp_dataimporter_configdataobject_loaddataobjectclassificationstoreattributes'),
                method: 'GET',
                params: {
                    'class_id': classId
                },
