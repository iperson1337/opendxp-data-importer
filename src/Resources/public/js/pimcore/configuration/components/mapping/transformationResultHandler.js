...
opendxp.registerNS('opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.transformationResultHandler');
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.transformationResultHandler = Class.create({
    ...
    updateData: function(fireUpdateEvent, callback) {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_dataimporter_configdataobject_loadtransformationresultpreviews'),
            method: 'POST',
            params: {
