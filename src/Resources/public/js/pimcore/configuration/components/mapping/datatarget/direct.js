...
opendxp.registerNS("opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.datatarget.direct");
opendxp.plugin.pimcoreDataImporterBundle.configuration.components.mapping.datatarget.direct = Class.create(opendxp.plugin.pimcoreDataImporterBundle.configuration.components.abstractOptionType, {
